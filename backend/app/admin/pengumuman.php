...
$pengumuman = paginate($conn, "pengumuman_guild", $page, 10);
$keys = $pengumuman["headers"];
$api_path_name = "pengumuman";
...
<body>
    ...
    <main>
        <div class="container">
            ...
            <div class="tabs">
                <a href="pengumuman.php" class="tab-btn active" data-tab="rank">Pengumuman</a>
            </div>
            ...
            <div class="table-container">
                <table>
                    ...
                    <tbody id="tableBody">
					<?php foreach($pengumuman["data"] as $user) { ?>
						<tr>
            ...
            <div class="pagination">
				<?php for ($i = 1; $i <= $pengumuman["total_pages"]; $i++): ?>
					<a class="page-btn <?php echo $i == $pengumuman['current_page'] ? 'active' : '' ?>" href="?page=<?php echo $i; ?>">
						<?php echo $i; ?>
					</a>
				<?php endfor; ?>
            </div>
