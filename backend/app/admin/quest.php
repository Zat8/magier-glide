...
$quest_master = paginate($conn, "quest_master", $page, 10);
$keys = $quest_master["headers"];
$api_path_name = "quest";
$page_title = "Quest";
...
<body>
    ...
    <main>
        <div class="container">
            ...
            <div class="tabs">
                <a href="quest.php" class="tab-btn active" data-tab="penyihir">Quest Table</a>
            ...
            <div class="table-container">
                <table>
                    ...
                    <tbody id="tableBody">
					<?php foreach($quest_master["data"] as $user) { ?>
						<tr>
            ...
            <div class="pagination">
				<?php for ($i = 1; $i <= $quest_master["total_pages"]; $i++): ?>
					<a class="page-btn <?php echo $i == $quest_master['current_page'] ? 'active' : '' ?>" href="?page=<?php echo $i; ?>">
						<?php echo $i; ?>
					</a>
				<?php endfor; ?>
            </div>
