...
$keys = $achievement["headers"];
$api_path_name = "achievement";
...
<body>
    ...
    <main>
        <div class="container">
            ...
            <div class="tabs">
                <a href="achievement.php" class="tab-btn active" data-tab="penyihir">Achievement Table</a>
                <a href="achievement-user.php" class="tab-btn" data-tab="rank">Achievement - User Table</a>
            </div>
            ...
            <div class="table-container">
                <table>
                    ...
                    <tbody id="tableBody">
					<?php foreach($achievement["data"] as $user) { ?>
						<tr>
            ...
            <div class="pagination">
				<?php for ($i = 1; $i <= $achievement["total_pages"]; $i++): ?>
					<a class="page-btn <?php echo $i == $achievement['current_page'] ? 'active' : '' ?>" href="?page=<?php echo $i; ?>">
						<?php echo $i; ?>
					</a>
				<?php endfor; ?>
            </div>
