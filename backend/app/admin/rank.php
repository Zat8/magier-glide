...
$rank_master = paginate($conn, "rank_master", $page, 10);
$keys = $rank_master["headers"];
$api_path_name = "rank";
$page_title = "Rank";
$select_id_name = "rank_level";
    ...
    <main>
        <div class="container">
            ...
            <div class="tabs">
                ...
                <a href="rank.php" class="tab-btn active" data-tab="rank">Rank Table</a>
            ...
            <div class="table-container">
                <table>
                    ...
                    <tbody id="tableBody">
					<?php foreach($rank_master["data"] as $user) { ?>
						<tr>
            ...
            <div class="pagination">
				<?php for ($i = 1; $i <= $rank_master["total_pages"]; $i++): ?>
					<a class="page-btn <?php echo $i == $rank_master['current_page'] ? 'active' : '' ?>" href="?page=<?php echo $i; ?>">
						<?php echo $i; ?>
					</a>
				<?php endfor; ?>
            </div>
