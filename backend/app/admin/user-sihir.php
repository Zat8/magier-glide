...
$user_sihir_list = paginate($conn, "users_sihir", $page, 10);
$keys = $user_sihir_list["headers"];
$api_path_name = "user-sihir";
$page_title = "Penyihir - Sihir";
$select_id_name = "id";
...
<body>
    ...
    <main>
        <div class="container">
            ...
            <div class="tabs">
                <a href="users.php" class="tab-btn" data-tab="penyihir">Penyihir Table</a>
                <a href="rank.php" class="tab-btn" data-tab="rank">Rank Table</a>
                <a href="sihir.php" class="tab-btn" data-tab="sihir">Sihir Table</a>
                <a href="user-sihir.php" class="tab-btn active" data-tab="user-sihir">User - Sihir Table</a>
            </div>
            ...
            <div class="table-container">
                <table>
                    ...
                    <tbody id="tableBody">
					<?php foreach($user_sihir_list["data"] as $user) { ?>
						<tr>
            ...
            <div class="pagination">
				<?php for ($i = 1; $i <= $user_sihir_list["total_pages"]; $i++): ?>
					<a class="page-btn <?php echo $i == $user_sihir_list['current_page'] ? 'active' : '' ?>" href="?page=<?php echo $i; ?>">
						<?php echo $i; ?>
					</a>
				<?php endfor; ?>
            </div>
