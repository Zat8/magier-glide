...
$sihir_list = paginate($conn, "sihir_master", $page, 10);
$keys = $sihir_list["headers"];
$api_path_name = "sihir";
$page_title = "Sihir";
$select_id_name = "sihir_id";
    ...
    <main>
        <div class="container">
            ...
            <div class="tabs">
                ...
                <a href="sihir.php" class="tab-btn active" data-tab="sihir">Sihir Table</a>
            ...
            <div class="table-container">
                <table>
                    ...
                    <tbody id="tableBody">
					<?php foreach($sihir_list["data"] as $user) { ?>
						<tr>
            ...
            <div class="pagination">
				<?php for ($i = 1; $i <= $sihir_list["total_pages"]; $i++): ?>
					<a class="page-btn <?php echo $i == $sihir_list['current_page'] ? 'active' : '' ?>" href="?page=<?php echo $i; ?>">
						<?php echo $i; ?>
					</a>
				<?php endfor; ?>
            </div>
