...
$quest_category = paginate($conn, "quest_category", $page, 10);
$keys = $quest_category["headers"];
$api_path_name = "category";
$page_title = "Category";
    ...
    <main>
        <div class="container">
            ...
            <div class="tabs">
                ...
                <a href="category.php" class="tab-btn active" data-tab="penyihir">Category Table</a>
                <a href="quest-user.php" class="tab-btn" data-tab="rank">Quest - User Table</a>
            </div>
            ...
            <div class="table-container">
                <table>
                    ...
                    <tbody id="tableBody">
					<?php foreach($quest_category["data"] as $user) { ?>
						<tr>
            ...
            <div class="pagination">
				<?php for ($i = 1; $i <= $quest_category["total_pages"]; $i++): ?>
					<a class="page-btn <?php echo $i == $quest_category['current_page'] ? 'active' : '' ?>" href="?page=<?php echo $i; ?>">
						<?php echo $i; ?>
					</a>
				<?php endfor; ?>
            </div>
